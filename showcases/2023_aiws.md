...
The Beginner group comprised students new to the field of data science. Throughout the program, they applied their knowledge to four diverse and practical datasets. They analyzed the datasets and performed all the processes of predicting through machine learning models, and wrote a Colab, an interactive python tool for sharing this process and results. The following are the results of their presentations and the information about the Colab.
...
The Advanced group consisted of students with prior data science experience. Their responsibilities included preparing and delivering practical training sessions for the Beginner group during the AI Winter School. During the self-study period, they explored and presented topics of their own interest.
